...
#ifndef _VV_MULTICAST2_H_
#define _VV_MULTICAST2_H_
...
/** Class for Multicasting
  Used to transfer data via multicasting to known hosts.
  If multicast transfer fails, tcp-transfer is used automatically

  @author Stavros Delisavas (stavros.delisavas@uni-koeln.de)
 */
class VIRVOEXPORT vvMulticast2
{
public:
  enum
  {
  ...
  /** Constructor creating a sending or receiving multicast-unit
    ...
    */
  vvMulticast2(const char* addr, const ushort port, const MulticastType type);
//  ~vvMulticast2();
