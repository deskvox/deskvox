...
*/
template <typename T>
vvBaseVector3<T> vvBaseVector3<T>::operator + ( const vvBaseVector3<T> &other ) const
{
  vvBaseVector3<T> vResult;

  for (int i = 0; i < 3; ++i)
  {
    vResult.e[i] = e[i] + other.e[i];
  }
...
template <typename T>
vvBaseVector3<T> vvBaseVector3<T>::operator + ( void ) const
{
  return *this;
}
...
template <typename T>
vvBaseVector3<T> vvBaseVector3<T>::operator * ( const T scalar ) const
{
  vvBaseVector3<T> vResult;
