...
const Format kFormats[] =
{
    ...
    Format(GL_R16I,                 GL_RED,                 GL_INT),
    Format(GL_RG16I,                GL_RG,                  GL_INT),
    Format(GL_RGB16I,               GL_RGB,                 GL_INT),
    Format(GL_RGBA16I,              GL_RGBA,                GL_INT),
    Format(GL_R32I,                 GL_RED,                 GL_INT),
    Format(GL_RG32I,                GL_RG,                  GL_INT),
    Format(GL_RGB32I,               GL_RGB,                 GL_INT),
    Format(GL_RGBA32I,              GL_RGBA,                GL_INT),
    Format(GL_R16UI,                GL_RED,                 GL_UNSIGNED_INT),
    Format(GL_RG16UI,               GL_RG,                  GL_UNSIGNED_INT),
    Format(GL_RGB16UI,              GL_RGB,                 GL_UNSIGNED_INT),
    Format(GL_RGBA16UI,             GL_RGBA,                GL_UNSIGNED_INT),
    Format(GL_R32UI,                GL_RED,                 GL_UNSIGNED_INT),
    Format(GL_RG32UI,               GL_RG,                  GL_UNSIGNED_INT),
    Format(GL_RGB32UI,              GL_RGB,                 GL_UNSIGNED_INT),
    Format(GL_RGBA32UI,             GL_RGBA,                GL_UNSIGNED_INT),
